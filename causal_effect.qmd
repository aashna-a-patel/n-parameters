...
I am analyzing the "shaming" dataset from Gerber, Green, and Larimer (2008) to determine the causal effect of postcards on voter turnout in the 2006 primary election and how it varies with political engagement. One problem with this approach is the potential influence of unmeasured confounders, such as personal motivation or local political events, that could affect both the likelihood of receiving a postcard and the decision to vote.